...
case "${CI_JOB}" in
	...
	"BAREMETAL-QAT"|"QAT")
		...
		;;
	"CRI_CONTAINERD"|"CRI_CONTAINERD_K8S"|"CRI_CONTAINERD_K8S_DEVMAPPER"|"CC_CRI_CONTAINERD"|"CC_CRI_CONTAINERD_CLOUD_HYPERVISOR"|"CC_SKOPEO_CRI_CONTAINERD"|"CC_SKOPEO_CRI_CONTAINERD_CLOUD_HYPERVISOR")
