...
case "${CI_JOB}" in
	...
	"CRI_CONTAINERD"|"CRI_CONTAINERD_K8S"|"CRI_CONTAINERD_K8S_DEVMAPPER")
		...
		;;
	"CC_CRI_CONTAINERD"|"CC_CRI_CONTAINERD_DEVMAPPER"|"CC_SKOPEO_CRI_CONTAINERD"|"CC_SKOPEO_CRI_CONTAINERD_DEVMAPPER"|"CC_CRI_CONTAINERD_CLOUD_HYPERVISOR"|"CC_CRI_CONTAINERD_CLOUD_HYPERVISOR_DEVMAPPER"|"CC_SKOPEO_CRI_CONTAINERD_CLOUD_HYPERVISOR"|"CC_SKOPEO_CRI_CONTAINERD_CLOUD_HYPERVISOR_DEVMAPPER")
		echo "INFO: Running Confidential Container tests"
		sudo -E PATH="$PATH" CRI_RUNTIME="containerd" bash -c "make cc-containerd"
		;;
	"CC_CRI_CONTAINERD_K8S"|"CC_CRI_CONTAINERD_K8S_DEVMAPPER"|"CC_SKOPEO_CRI_CONTAINERD_K8S"|"CC_SKOPEO_CRI_CONTAINERD_K8S_DEVMAPPER")
