...
func TestCheckCommitBody(t *testing.T) {
	...
	data := []testData{
		...
		{[]string{"bar10", "Fixes:github.com/kata-containers/runtime#999", "Signed-off-by: me@foo.com"}, config, false, true},
		{[]string{"bar11", "Fixes  github.com/kata-containers/agent#1", "Signed-off-by: me@foo.com"}, config, false, true},
		{[]string{"bar11", "Fixes  #999, github.com/kata-containers/agent#1", "Signed-off-by: me@foo.com"}, config, false, true},
		{[]string{"bar11", "Fixes : github.com/kata-containers/agent#1, #9999", "Signed-off-by: me@foo.com"}, config, false, true},
		{[]string{"bar12", "Fixes : github.com/kata-containers/kata-containers#999", "Signed-off-by: me@foo.com"}, config, false, true},
		{[]string{"bar12", "Fixes : github.com/kata-containers/.github#999", "Signed-off-by: me@foo.com"}, config, false, true},
		{[]string{"bar13", "Fixes  : github.com/kkkkata-containers/agent#1", "Signed-off-by: me@foo.com"}, config, false, false},
		{[]string{"你好", "fixes: #999", "Signed-off-by: me@foo.com"}, config, false, true},
