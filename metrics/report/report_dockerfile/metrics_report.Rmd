...
```{r memory-footprint, echo=FALSE, fig.cap="Memory PSS footprint", results='asis'}
...
```{r footprint-density, echo=FALSE, fig.cap="System Memory density", results='asis'}
test_name_extra="-ksm"
...
```{r mem-in-cont, echo=FALSE, fig.cap="System Memory density", results='asis'}
...
```{r lifecycle-time, echo=FALSE, fig.cap="Execution lifecycle times", results='asis'}
